...
'''------FUNCTION------'''
'''------CREATE POINTS------'''
#stage = input('Enter what stage (design, late low, late mid, late high) ')
stage = 'design'
if stage == 'design':
...
for q in range(0,iterations):
    ...
    for z in range(0,trials):
        ...
        h_LOUIS.append(((((Dv_LOUIS * 2.25 )**2))/(((distance[z]) ** 2))))
        ...
        if 0<=theta[z]<=math.pi/2 and 0<=psi[z]<=math.pi:
            thetaobs.append(2 * math.asin(math.sin(theta[z]) * math.sin(psi[z]/2)))
        elif 0<=theta[z]<=math.pi/2 and math.pi<psi[z]<= 2*math.pi:
            thetaobs.append(2 * math.asin(math.sin(theta[z]) * math.sin((2*math.pi-psi[z])/2)))   
            
        elif math.pi/2<theta[z]<=math.pi and 0<=psi[z]<=math.pi:
            thetaobs.append(2 * math.asin(-1 * math.cos(theta[z]) * math.sin(psi[z]/2)))
        elif math.pi/2<theta[z]<=math.pi and math.pi<psi[z]<= 2*math.pi:
            thetaobs.append(2 * math.asin(-1 * math.cos(theta[z]) * math.sin((2*math.pi-psi[z])/2)))
            
            
        else:
            thetaobs.append(None)
    ...
    for f in range(0, trials):
        ...
        antenna_power.append((RHO_PLUS_LOUIS[f]**2) + (RHO_CROSS_LOUIS[f] ** 2) + 
                             (RHO_PLUS_WASH[f] ** 2) + (RHO_CROSS_WASH[f] ** 2) +
                             (RHO_PLUS_VIRGO[f] ** 2) + (RHO_CROSS_VIRGO[f] ** 2))
...
print('GRB Volume Off Axis '+ str((((450)**3) * math.pi * (4/3) * GRBPERCENT_off)/(1000**3)) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GRBSD_off))/(1000**3)))
print('GWGRB Volume Off Axis '+ str((((450)**3) * math.pi * (4/3) * GWGRBPERCENT_off)/(1000**3)) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GWGRBSD_off))/(1000**3)))
print('All volumes in Gpc^3')
print(' ')
print('GWGRB/GW, percent detection Off Axis ' + str(100 * ((((450)**3) * math.pi * (4/3) * GWGRBPERCENT_off)/(1000**3))/(((((450)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3)))))
...
print(' ')
print('GW Volume '+ str(((((450)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3))) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GWSD)/(1000**3))))
print('GRB Volume Structured Simulation '+ str((((450)**3) * math.pi * (4/3) * GRBPERCENT_struc_sim)/(1000**3)) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GRBSD_struc_sim))/(1000**3)))
print('GWGRB Volume Structured Simulation '+ str((((450)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_sim)/(1000**3)) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GWGRBSD_struc_sim))/(1000**3)))
print('All volumes in Gpc^3')
print(' ')
print('GWGRB/GW, percent detection Structured Simulation ' + str(100 * ((((450)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_sim)/(1000**3))/(((((450)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3)))))
#Structured Best
print(' ')
...
print(' ')
print('GW Volume '+ str(((((450)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3))) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GWSD)/(1000**3))))
print('GRB Volume Structured Best '+ str((((450)**3) * math.pi * (4/3) * GRBPERCENT_struc_best)/(1000**3)) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GRBSD_struc_best))/(1000**3)))
print('GWGRB Volume Structured Best '+ str((((450)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_best)/(1000**3)) + ' +/- ' + str(((((450)**3) * math.pi * (4/3) * GWGRBSD_struc_best))/(1000**3)))
print('All volumes in Gpc^3')
print(' ')
print('GWGRB/GW, percent detection Structured Best ' + str(100 * ((((450)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_best)/(1000**3))/(((((450)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3)))))
print(' ')
print(' ')
print('maximum antenna power pattern data')
max_antenna_power = max(antenna_power)
average_antenna_power = sum(antenna_power)/len(antenna_power)
max_theta = theta[antenna_power.index(max_antenna_power)]
max_phi = phi[antenna_power.index(max_antenna_power)]
max_psi = psi[antenna_power.index(max_antenna_power)]
print('Max antenna power pattern: ' + str(max_antenna_power))
print('Average antenna power pattern: ' + str(average_antenna_power))
print('Max theta @ antenna power pattern: ' + str(max_theta))
print('Max phi @ antenna power pattern: ' + str(max_phi))
print('Max psi @ antenna power pattern: ' + str(max_psi))
