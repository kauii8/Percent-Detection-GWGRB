...
for q in range(0,iterations):
    ...
    for z in range(0,trials):
        ...
        distance.append(random.uniform(0.0,270.0))
        ...
        thetaobs.append(2 * math.asin(math.sin(theta[z]) * math.sin(psi[z]/2)))#Fermi Observation angle set
    '''------CREATE POINTS-------'''
    ...
    for f in range(0, trials):
        ...
        SNRcalculated.append(((SNRcalculatedLOUISsig[f] + SNRcalculatedWASHsig[f] + SNRcalculatedVIRGOsig[f])**2)/(2))                           
...
print(' ')
print('GW Volume '+ str(((((270)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3))) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GWSD)/(1000**3))))
print('GRB Volume Off Axis '+ str((((270)**3) * math.pi * (4/3) * GRBPERCENT_off)/(1000**3)) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GRBSD_off))/(1000**3)))
print('GWGRB Volume Off Axis '+ str((((270)**3) * math.pi * (4/3) * GWGRBPERCENT_off)/(1000**3)) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GWGRBSD_off))/(1000**3)))
print('All volumes in Gpc^3')
print(' ')
print('GWGRB/GW, percent detection Off Axis ' + str(100 * ((((270)**3) * math.pi * (4/3) * GWGRBPERCENT_off)/(1000**3))/(((((270)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3)))))
...
print(' ')
print('GW Volume '+ str(((((270)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3))) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GWSD)/(1000**3))))
print('GRB Volume Structured Simulation '+ str((((270)**3) * math.pi * (4/3) * GRBPERCENT_struc_sim)/(1000**3)) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GRBSD_struc_sim))/(1000**3)))
print('GWGRB Volume Structured Simulation '+ str((((270)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_sim)/(1000**3)) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GWGRBSD_struc_sim))/(1000**3)))
print('All volumes in Gpc^3')
print(' ')
print('GWGRB/GW, percent detection Structured Simulation ' + str(100 * ((((270)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_sim)/(1000**3))/(((((270)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3)))))
#Structured Best
print(' ')
...
print(' ')
print('GW Volume '+ str(((((270)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3))) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GWSD)/(1000**3))))
print('GRB Volume Structured Best '+ str((((270)**3) * math.pi * (4/3) * GRBPERCENT_struc_best)/(1000**3)) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GRBSD_struc_best))/(1000**3)))
print('GWGRB Volume Structured Best '+ str((((270)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_best)/(1000**3)) + ' +/- ' + str(((((270)**3) * math.pi * (4/3) * GWGRBSD_struc_best))/(1000**3)))
print('All volumes in Gpc^3')
print(' ')
print('GWGRB/GW, percent detection Structured Best ' + str(100 * ((((270)**3) * math.pi * (4/3) * GWGRBPERCENT_struc_best)/(1000**3))/(((((270)**3) * math.pi * (4/3) * GWPERCENT)/(1000**3)))))
