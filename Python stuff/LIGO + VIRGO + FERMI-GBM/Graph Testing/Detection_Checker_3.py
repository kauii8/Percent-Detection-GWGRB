...
RHO_PLUS_WASH, RHO_CROSS_WASH, RHO_PLUS_VIRGO, RHO_CROSS_VIRGO = [], [], [], []
mult = .001 
...
for a in range(0,trials):
    ...
    frequency.append(random.uniform(10**1.5, 10e3))
    h.append((3.086e+22 * distance[datacounter])/frequency[datacounter])
    PSD.append(9.29389e-23 * frequency(datacounter))
...
for f in range(0, trials):
    ...
    + ((RHO_CROSS_VIRGO[SNRnum]) ** 2)) INTEGRAL STUFF * * ))
